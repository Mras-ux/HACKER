...
import { User, Lock, Eye, EyeOff, AlertCircle, UserPlus, Mail } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLoginMode) {
      ...
      try {
        ...
        if (registerSuccess) {
          setSuccess('注册申请已提交！请等待管理员审核激活账户。我们会在24小时内处理您的申请。');
          // 清空表单
          setUsername('');
          setPassword('');
          setConfirmPassword('');
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
            {isLoginMode ? '登录到 HACKER交流会' : '申请加入 HACKER交流会'}
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            {isLoginMode ? '欢迎回来！请登录您的账户' : '提交申请加入我们的算法学习社区'}
          </p>
        </div>
              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="请简要介绍自己的编程背景、学习经历或参赛经验，以便管理员了解您的情况..."
                  />
                </div>
              </>
            )}
              ...
              >
                {isLoading ? (
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{isLoginMode ? '登录中...' : '提交申请中...'}</span>
                  </div>
                ) : (
                  <div className="flex items-center space-x-2">
                    {isLoginMode ? (
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="bg-blue-50 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-blue-900">申请说明</h4>
                    <p className="text-sm text-blue-700 mt-1">
                      提交申请后需要管理员审核激活账户。我们会在24小时内处理您的申请，请耐心等待。审核通过后会通过邮箱通知您。
                    </p>
                  </div>
                </div>
              </div>
